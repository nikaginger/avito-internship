...
function Steps(props) {
  ...
  // ============================= styles =============================
  const classString = (0, _classnames.default)(prefixCls, `${prefixCls}-${mergedOrientation}`, `${prefixCls}-title-${mergeTitlePlacement}`, rootClassName, className, classNames.root);
